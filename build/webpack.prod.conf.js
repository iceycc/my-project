...
const UglifyJsPlugin = require('uglifyjs-webpack-plugin') //用于优化和最小化js资源

const env = process.env.NODE_ENV === 'testing'//判断是测试环境还是生产环境  载入不同的配置
...
const webpackConfig = merge(baseWebpackConfig, {
  ...
  devtool: config.build.productionSourceMap ? config.build.devtool : false,// 是否使用source-map
  ...
  plugins: [// webpack插件
    ...
    // keep module.id stable when vendor modules does not change  TODO:
    new webpack.HashedModuleIdsPlugin(),
    // enable scope hoisting  TODO:
