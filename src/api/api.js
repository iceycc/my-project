...
import Qs from 'qs';
import AJAX from 'axios' //用于处理service.intra.uzhuang.com 下的接口
...
export const doLogin = (params) => {
    return Request.post(Method.doLogin, params)
        .then((result) => {
            EventBus.$emit('notice', {
                type: 'message',
...
export const checkEmailHandel = (params) => {
    return Request.get(Method.checkEmailHandel, {params})
        .then((result) => {
            //0：过期，1：账号已激活，2：激活成功
            return result
        })
...
export const activeRegister = (params) => {
    return Request.get(Method.activeRegister, {params})
        .then((result) => {
            return result
        })
}
...
export const doRegister = (params) => {
    return Request.post(Method.doRegister, params)
        .then((result) => {
            return result
        })
}
...
export const sendEmail = (params) => {
    return Request.get(Method.sendEmail, {params})
        .then((result) => {
            return result
        })
}
...
export const activationEmail = (params) => {
    return Request.post(Method.activationEmail, params)
        .then((result) => {
            return result
        })
}
...
export const getProvence = () => {
    return AJAX.get(Method.getProvence, {})
        .then((result) => {
            return result
        })
}
...
export const getCity = (params) => {
    return AJAX.get(Method.getCity, {params})
        .then((result) => {
            return result
        })
}
...
// 首页搜索框搜索 待定
export const doIndexSearch = (params) => {
    return Request.get(Method.doIndexSearch, {params})
        .then((result) => {
            return result
        })
}
