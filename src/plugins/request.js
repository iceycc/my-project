...
import axios from '../config/request/axiosInstance'; // axios
import {Constants, EventBus} from '../config/index'; //
...
class Request {
    ...
    // type(url, param, success, fail, finish) {
    //   //
    //   return this._request(url, this.type, param, success, fail, finish);
    // }
